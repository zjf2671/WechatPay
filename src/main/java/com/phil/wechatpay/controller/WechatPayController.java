...
import com.phil.common.util.MD5Util;
...
import com.phil.wechatauth.model.req.AuthTokenParams;
...
public class WechatPayController {
	...
	public String prePayPage(HttpServletRequest request, HttpServletResponse response, String url) throws Exception {
		...
		if(state.equals(MD5Util.MD5Encode("ceshi", ""))){
			...
			authAccessToken = wechatAuthService.getAuthAccessToken(authTokenParams, WechatConfig.ACCESS_TOKEN_URL);	
		}
